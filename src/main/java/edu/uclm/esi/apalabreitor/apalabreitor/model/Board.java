...
public class Board {
	...
	public ResultadoJugada movement(List<JSONObject> jugada) {
		...
		try {
			...
			if (!centroOcupado) 
				...
				comprobarAdyacencia(jugada);//que toque a la palabra que ya tengamos en el tablero para que sea valido
	...
	private List<Cadena> construirCadenas(List<JSONObject> jugada, boolean enVertical) throws JSONException {//devuelve las nuevas cadenas formadas con las letras que ha añadido el usuario
		Cadena cadena;
		JSONObject casilla;
